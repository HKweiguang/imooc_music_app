package com.robooot.ft_home.api;
...
public class RequestCenter {
    ...
    static class HttpConstants {
        ...
        private static final String HOME_RECOMMAND_MORE = ROOT_URL + "/module_voice/home_recommand_more";

        private static final String HOME_FRIEND = ROOT_URL + "/module_voice/home_friend";
    }
