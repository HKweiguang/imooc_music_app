...
import com.imooc.lib_common_ui.recyclerview.CommonAdapter;
import com.imooc.lib_common_ui.recyclerview.base.ViewHolder;
import com.imooc.lib_common_ui.recyclerview.wrapper.HeaderAndFooterWrapper;
...
import com.robooot.ft_home.model.discory.BaseRecommandModel;
import com.robooot.ft_home.model.discory.BaseRecommandMoreModel;
import com.robooot.ft_home.model.discory.RecommandBodyValue;

import java.util.ArrayList;
import java.util.List;

public class DiscoryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, LoadMoreWrapper.OnLoadMoreListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        @SuppressLint("InflateParams") View rootView = inflater.inflate(R.layout.fragment_discory_layout, null);
