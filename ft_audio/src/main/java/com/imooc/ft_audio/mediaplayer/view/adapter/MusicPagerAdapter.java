package com.imooc.ft_audio.mediaplayer.view.adapter;
...
public class MusicPagerAdapter extends PagerAdapter {
     ...
     * data
     */
    private final ArrayList<AudioBean> mAudioBeans;
    private final SparseArray<ObjectAnimator> mAnims = new SparseArray<>();
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        @SuppressLint("InflateParams") View rootView = LayoutInflater.from(mContext).inflate(R.layout.indictor_item_view, null);
